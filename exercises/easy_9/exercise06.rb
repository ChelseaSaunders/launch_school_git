...
# PROBLEM:
#   Input: string of words separated by exactly one space
#   Output: array
...
create a method word_lengths that takes one string as an argument
split string into array of word strings using " " as break for each word
iterate through the string
determine lengh (integer) of each element
convert length into a string
append a ' ' and length (string) onto each element in the array
