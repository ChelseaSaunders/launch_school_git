...
# and returns only elements that have five or more characters, and reverses them
# I then use the .join method with a space as an argument to convert the array
# back into a string. 
