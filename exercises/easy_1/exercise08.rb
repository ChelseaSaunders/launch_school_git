...
# Examples/test cases:
# THree test cases are provided: 1, 6; 1, 5, 87, 45, 8, 8; and 9, 47, 23, 95,
# 16, 52.  Given that the problem specifics eliminate the possibility of
# negative integers and input that isn't an integer, I don't see any unsual
# edge cases that the provided test cases wouldn't account for.
...
# the last element in the array, using the .pop method. I will then create a
# new variable "answer" and assign it to the new_num plus the sum--thus. I will
...
# sum (generated from the completed loop), and "divider", (the variable
# assigned to the number of elements in the array). I will then call "average"
# so that method returns the "average" variable.
